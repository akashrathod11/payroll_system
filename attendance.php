    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                ...
                $is_admin = true; // Replace this with your logic to check if the user is an admin
                if ($is_admin) {
                    echo '<button class="btn btn-primary btn-sm btn-block col-md-3 float-right" type="button" id="new_attendance_btn"><span class="fa fa-plus"></span> Add Attendance</button>';
                }
                ?>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        ...
                                        // Check if the user is an admin
                                        if ($is_admin) {
                                            echo '<button class="btn btn-sm btn-outline-danger remove_attendance" data-id="' . $key . '" type="button"><i class="fa fa-trash"></i></button>';
                                            echo '<button class="btn btn-sm btn-outline-primary edit_attendance" data-id="' . $key . '" type="button"><i class="fa fa-edit"></i></button>';
                                        }
                                        ?>
                                    </center>
                                </td>
